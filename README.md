...
- A 股、港股、美股、加密资产统一自选
- 1 日、1 周、1 月、3 月、1 年 K 线
- 按市场筛选、名称/代码搜索、自定义代码添加
- 下拉刷新与本地行情缓存
- 无登录、无广告、无埋点
...
当前 MVP 通过 Yahoo Finance Chart 的公开网络接口读取行情，不需要 API Key。该接口并非为本项目提供 SLA 的商业服务，可能限流、延迟或调整；若用于 App Store 正式产品或交易决策，请替换为有授权和稳定性承诺的数据供应商。
